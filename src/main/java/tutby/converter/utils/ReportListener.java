...
public class ReportListener extends TestListenerAdapter {
    ...
    private ScreenshotDatePath makeScreenshot(String screenshotFolder, ITestResult tr, WebDriver driver) {
        ...
        String destPath = DEFAULT_OUTPUTDIR + "/" + screenshotFolder + "/" + tr.getName() + "_" + fileNameFormater.format(d.getTime()) + ".png";
        ScreenshotDatePath screenshotDatePath = new ScreenshotDatePath(Long.toString(d.getTime()), destPath, tr);
