...
public class JustClicksOnAllControlsTest extends AbstractTest {
	...
	public void Test() {
		...
		mainPage.getCrossRateFor("Польский злотый", "Российский рубль");
		mainPage.getCrossRateFor("Евро", "Украинская гривна");
		mainPage.getCrossRateFor("Доллар США", "Польский злотый");
		...
		mainPage.reselectConverterCurrency("Австралийский доллар", "СДР");
